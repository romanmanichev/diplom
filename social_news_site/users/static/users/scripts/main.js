...
modal__signin_close.click(() => {
    modal_signin.removeClass('active')
    $('.modal__errors').removeClass('active')
});
...
$('.create__theme').submit(function (e) {
    ...
    $.ajax({
        ...
        error: function(response) {
            ...
            $('.create__category').css('border', '')
            $('.create__title').css('border', '')
            $('.create__content').css('border', '')

            $('.create__category__error').text('')
            $('.create__title__error').text('')
            $('.create__content__error').text('')
